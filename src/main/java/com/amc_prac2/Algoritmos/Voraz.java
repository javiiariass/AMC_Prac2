...
//    }
     ...
     * busca el proximo Punto mas cercano desde el ultimo aniadido
     * @param puntos Lista de los Puntos
     * @param ciudadInicial Punto inicial desde el que iniciar la busqueda / ruta.
     * El primer punto es el 0 -> si ciudadInicial == 3 -> 4o elemento de la lista
     * @return devuelve objeto de tipo Ruta -> contiene array con la solucion, la distancia total
     * y el numero de veces que ha tenido que calcular la distancia euclidea
     */
     ...
     * <p>Busqueda voraz bidireccional exhaustiva: no hace poda,
     * busca el proximo Punto mas cercano desde el primer y ultimo punto
     * @param puntos Lista de los Puntos
     * @param ciudadInicial Punto inicial desde el que iniciar la busqueda / ruta.
     * El primer punto es el 0 -> si ciudadInicial == 3 -> 4o elemento de la lista
     * @return devuelve objeto de tipo Ruta -> contiene array con la solucion, la distancia total
